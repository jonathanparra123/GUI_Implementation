...
public class ToolPane extends HBox {
    ...
    //class where pane options are stored including buttons.
    public ToolPane() {
    ...
    //methods to access variables in class
    public void setFillPickerAction(EventHandler<ActionEvent> event) {fillPicker.setOnAction(event);}
